...
let channel = getUrlParam("channel", "activeenergy").toLowerCase();
log(channel);
let emotes = [];
...
async function getEmotes(check) {
  ...
  //   method: "GET",
  //   headers: { "User-Agent": "activeenergy.github.io/projectemote" },
  // }).then(
  //   function (response) {
...
function connect() {
  ...
  chat.onopen = function () {
    ...
    chat.send("PASS oauth:dcih36t3nlbfwqnyzw2axnhkijlwl2");
    chat.send("NICK activeenergy");
